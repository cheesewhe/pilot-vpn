...
| Kernel | 6.8.0-106-generic (reboot-required for 6.8.0-134-generic) |
| Arch | x86_64 |
| Virt | KVM |
| CPU | 6 vCPU AMD EPYC |
| RAM | ~11 GiB |
| Swap | none (planned Stage 1) |
...
|------|-------|---------|------|-------|
| 22 | tcp | sshd | ED25519 keys | Only public service |
...
|-----------|--------|----------|
| vpn-project tree | Stage 0 | `/opt/vpn-project` |
| Runtime dirs | Stage 0 | `/etc`, `/var/lib`, `/var/log` vpn-project |
| fail2ban | not installed | |
| UFW | installed?, inactive | Stage 1 |
